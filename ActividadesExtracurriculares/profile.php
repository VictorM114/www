  ...
  <nav class="navbar navbar-expand-sm bg-light ">
      ...
      <img src="images/logo.jfif" width="30" height="30" class="d-inline-block align-top" alt="">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="solicitudes-pendientes.php">Solicitudes Pendientes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="solicitudes-aprobadas.php">Solicitudes Aprobadas</a>
          </li>
          <li class="nav-item">
    ...
    <br>
          ...
          <div class = "container">
            <div class = "jumbotron">
          <h2>Bienvenido/a <?php echo $_SESSION['Fname'];?></h2>
          </div>
